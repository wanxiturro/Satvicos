...
$(document).ready(function(){
  ...
  $(document).prop('title', 'Proveedores - Satvicos');
});

$('select[name="proveedor_banco_1"], select[name="proveedor_banco_2"]').select2({
    data: [
        { id:"", text:"Seleccione" },
        { id:"Banco de Venezuela", text:"Banco de Venezuela" },
        { id:"BBVA", text:"BBVA" },
        { id:"Bancamiga", text:"Bancamiga" },
        { id:"Banco del Tesoro", text:"Banco del Tesoro" },
        { id:"Mencartil", text:"Mencartil" },
...
$('select[name="proveedor_tipmoneda_1"], select[name="proveedor_tipmoneda_2"]').select2({
    data: [
        { id:"", text:"Seleccione" },
        { id:"MN", text:"Moneda Nacional (Bs.S)" },
        { id:"MD", text:"Moneda Extranjera (USD)" },
        { id:"ME", text:"Moneda Extranjera (EUR)" }
    ]
});
