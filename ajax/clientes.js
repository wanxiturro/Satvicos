$(document).ready(function(){
  ...
  $(document).prop('title', 'Reportes de Clientes - Satvicos');
});

$.post(
  "../../modules/clientes/listar-clientes.php",
  function(data) {
...
$("#btn-rpt-ventas-por-cliente").click(function (e) {
    ...
    var url="../../modules/reportes/ventas-por-cliente.php?client_id=" + customerId 
