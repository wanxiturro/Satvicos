                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>RIF</label>
                                        <input minlength="1" maxlength="9" type="text" class="form-control" placeholder="Ingrese RIF" name="cliente_ruc" required>
                                    </div>
                                </div>
                                <div class="col-md-5">
                                    <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" class="form-control" placeholder="Ingrese teléfono fijo" name="cliente_telfij">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" class="form-control" placeholder="Ingrese teléfono celular" name="cliente_telcel">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Parroquia</label>
                                            ...
                                            <input type="text" class="form-control" placeholder="Ingrese una parroquia" name="cliente_parroquia" required>
                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="phone" class="form-control" name="cliente_celcont_1">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="phone" class="form-control" name="cliente_celcont_2">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
