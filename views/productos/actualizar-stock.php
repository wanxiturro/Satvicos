                            ...
                            <div class="row">
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <div class="custom-control custom-radio">
                                            <input class="custom-control-input" type="radio" name="mov_tipo" id="rbtnSalida" value="Salida">
                                            <label for="rbtnSalida" class="custom-control-label">Retiro del Almacén</label>
                                        </div>
                                        <div class="custom-control custom-radio">
