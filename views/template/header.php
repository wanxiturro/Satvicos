...
<head>
  ...
  <!-- Favicons -->
  <link rel="icon" href="<?php echo $functions->direct_sistema(); ?>/img/favo.png" sizes="32x32" >
  <link rel="icon" href="<?php echo $functions->direct_sistema(); ?>/img/favo.png" sizes="16x16" >
