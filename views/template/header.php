...
<head>
  ...
  <!-- Favicons -->
  <link rel="icon" href="<?php echo $functions->direct_sistema(); ?>/img/favicons/favicon-32x32.png" sizes="32x32" >
  <link rel="icon" href="<?php echo $functions->direct_sistema(); ?>/img/favicons/favicon-16x16.png" sizes="16x16" >
