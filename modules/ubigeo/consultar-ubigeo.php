...
switch ($MODO_UBIGEO) {
    case 'DEPARTMENTS':
        $sqlStatement = $pdo->prepare("SELECT * FROM ubigeo_venezuela_departments");
    ...
    case 'PROVINCES':
        ...
        $sqlStatement = $pdo->prepare("SELECT * FROM ubigeo_venezuela_municipalities WHERE department_id=:IDDEP");
    ...
    case 'DISTRICTS':
        ...
        $sqlStatement = $pdo->prepare("SELECT * FROM ubigeo_venezuela_parishes WHERE province_id=:IDPROV");
